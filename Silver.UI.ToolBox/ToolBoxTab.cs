...
namespace Silver.UI
{
    ...
    public class ToolBoxTab : ToolBoxItem
    {
        ...
        private ToolBoxItemCollection   _toolItems; // Array of toolbox items.
        ...
        private int                     _itemSpacing;    // This tab's item spacing.(if left zero, parent's item spacing will be used)

        private int                     _newItemIndex;    // New item index which got added recently.
      ...
      [Category("ToolBoxTab")]
        ...
        {
            get{return _selItemIndex < 0 ? null : this[_selItemIndex];}
            set
            {
                if(null != _toolItems)
                {
            ...
            if(null == _control && _parent.EndRenameItem())
            {
                ...
                if(_parent.Created)
                {
                    ...
                    if(!_selected)
                    {
                        _selected     = true;
                        _newItemIndex = index;
                        _parent.OnTabSelectionChanged(this,this.OnLayoutFinished);
                    }
                    else
                    {
                        UpdateNewItem(index);
        ...
        private void UpdateNewItem(int index)
        {
            ...
            if(index < _toolItems.Count && 0 <= index)
            {
                ...
                if (_selItemIndex >= 0 && null != this[_selItemIndex])
                {
                    _toolItems[_selItemIndex].Selected = false;
                }
